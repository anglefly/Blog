...
- [Array对象](https://www.runoob.com/jsref/jsref-obj-array.html) 其实有时候我记不住那么多的方法和参数，但是看一眼就好了
- [RGB&16进制互相转换](https://c.runoob.com/front-end/55) 有时候设计师只给一个东西，但是我们想在代码中统一风格只能自己手动转换
- [vscode快捷键](https://blog.csdn.net/p358278505/article/details/74221214) 这个不是很新但也够用
...
- [Evan's blog](https://xugaoyi.com/pages/1da0bf9a988eafe5/) 博客搭建、百度收录推送、评论系统相关
