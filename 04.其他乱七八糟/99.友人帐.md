...
```yaml
- name: 爱笑的阿杰
  desc: 后端大佬，带你成为砸瓦（Java）大神
  avatar: https://cdn.yangxj.top/avatar.jpg # 可选
  link: https://yangxj.top/ # 可选
  bgColor: "#817A82" # 可选，默认var(--bodyBg)。颜色值有#号时请添加单引号
